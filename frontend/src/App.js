...
function App() {
  ...
  const [mapCenter] = useState([40.7128, -74.006]); // NYC center
  ...
  const fetchOptimizationHistory = async () => {
    try {
      ...
      setOptimizationHistory(response.data.slice(-10));
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-medium mb-2">Selected Stops</h3>
                  <ul className="text-xs bg-gray-100 p-2 rounded space-y-1">
                    {selectedStops.map((id, idx) => (
                      <li key={idx}>
                        {idx + 1}. {getNodeName(id)}
                      </li>
                    ))}
                  </ul>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {(routeResult.execution_time * 1000).toFixed(2)} ms
                    </span>
                  </div>
                  <div className="mt-3">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-4 bg-gray-50 border-b">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  {routeResult
                    ? `Showing ${routeResult.algorithm.toUpperCase()} route: ${routeResult.distance.toFixed(
                        2
                      )} km`
                    : "Select at least 2 stops, then choose an algorithm"}
                </p>
              </div>
